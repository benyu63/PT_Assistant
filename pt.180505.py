...
try:                        #  这个日志文件过大或者出现问题，可以直接删除，不影响程序运行
    ...
    else:                   #  Windows目录分隔符及编码跟Linux不同，必须分别处理
        log_filename = re.sub( r'/[^/]+$', '', os.path.abspath(__file__) ) + r'/pt.log'
...
if ( mail_content != '' ):  #  发邮件
    ...
    mail_pass = ''  #  邮箱密码
    '''
    mail_host = 'smtp.163.com'          #  邮箱smtp服务器地址
    mail_user = 'pt_assistant@163.com'  #  邮箱用户名
    mail_pass = '1234qwer'              #  邮箱密码
    message = MIMEText( mail_content, 'plain', 'utf-8')
    message['from'] = mail_user
    message['to'] = '714447@qq.com'
